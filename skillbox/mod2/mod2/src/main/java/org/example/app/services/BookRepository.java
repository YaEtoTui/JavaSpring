...
public class BookRepository implements ProjectRepository<Book>, ApplicationContextAware {
    ...
    public boolean removeItemByRegex(String regexToRemove) {
        ...
        if (checkBookIsInteger(regexToRemove)) {
            parameterSource.addValue("size", Integer.parseInt(regexToRemove));
        ...
        logger.info("remove list books by regex completed");
        return true;
    }

    /*проверяем, что строка типа Integer и является размером книги*/
    private boolean checkBookIsInteger(String regexToRemove) {
